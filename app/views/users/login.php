                    ...
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                            ...
                            <div class="row px-3 form-group">
                                <label for="email" class="mb-1"><h6 class="mb-0 text-sm">Email Address<sup style="color:red;">*</sup></h6></label>
                            ...
                            <div class="row px-3 form-group">
                                <label for="password" class="mb-1"><h6 class="mb-0 text-sm">Password<sup style="color:red;">*</sup></h6></label>
                            ...
                            <div class="row px-1 ">
                                <small class="font-weight-bold">Don't have an account? <a href="<?php echo URLROOT; ?> 
                                /users/register" class="text-danger text-decoration-none"> Register Now</a></small>
                            </div>
                        </div>
                    </div>
                </div>
