                            ...
                            <div class="card2 card border-0 px-4 py-6">
                                ...
                                <div class="row px-3 form-group">
                                    ...
                                    <input type="text" name="fname" placeholder="Enter first name"
                                           class="form-control mb-4 <?php echo (!empty($data['fname_err'])) ? 'is-invalid' : ''; ?>"
                                ...
                                <div class="row px-3 form-group">
                                    ...
                                    <input type="text" name="lname" placeholder="Enter last name"
                                           class="form-control mb-4 <?php echo (!empty($data['lname_err'])) ? 'is-invalid' : ''; ?>"
                                ...
                                <div class="row px-3 form-group">
                                    ...
                                    <input type="email" name="edu_email" placeholder="Enter your edu email address"
                                           class="form-control mb-4 <?php echo (!empty($data['edu_email_err'])) ? 'is-invalid' : ''; ?>"
                                           value="<?php echo $data['edu_email']; ?>">
                                ...
                                <div class="row px-3 form-group">
                                    ...
                                    <input type="password" name="confirm_password" placeholder="Confirm Password "
                                           class="form-control mb-4 <?php echo (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>"
                                           value="<?php echo $data['confirm_password']; ?>">
                                    <span class="invalid-feedback"><?php echo $data['confirm_password_err']; ?></span>
                                </div>
                                <div class="row mb-3 px-3">
                                    <input class="btn btn-block button-background-color " name="signup" type="submit"
                                           value="Register">
                                </div>
                                <div class="row px-3 ">
                                    <small class="font-weight-bold text-center mb-4">Already a member? <a
                                                href="<?php echo URLROOT; ?>/users/login"
                                                class="text-danger text-decoration-none">Sign in</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
