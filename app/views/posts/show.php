            ...
            <div class="col-md-8 mb-3">
                <div class="card">
                    ...
                    <div class="px-5 py-2">
                        ...
                        <hr>
                        <div class="row py-1">
                            <div class="col-sm up-down-vote-icon "><b>50</b>
                                <button class="btn btn-sm btn-outline-success ms-2"><i
                                            class="fa-solid fa-arrow-up "></i></button>
                            </div>
                            <div class="col-sm up-down-vote-icon"><b>12</b>
                                <button class="btn btn-sm btn-outline-danger ms-2"><i
