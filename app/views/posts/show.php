                ...
                <div class="card">
                    <div class="d-flex justify-content-between p-2 px-3">
                        <div class="d-flex flex-row align-items-center"><img
                                    src="https://bootdey.com/img/Content/avatar/avatar7.png" width="40"
                                    class="rounded-circle">
                            <div class="d-flex flex-column"><span
                                        class="font-weight-bold"><?php echo $data['post']->title; ?></span>
                                <small class="text-primary">Category: <?php echo $data['post']->category; ?></small>
                            </div>
                        </div>
                        <div class="d-flex flex-row mt-1 ellipsis"><small
                                    class="mr-2"><?php echo $data['post']->created_time; ?></small></div>
                    </div>
                    <div class="text-center">
                        <img src="<?php echo $data['post']->img_link; ?>" width="50%" height="auto"
                    ...
                    <div class="px-5 py-2">
                        ...
                        <div class="row py-1">
                            ...
                            <div class="col-sm up-down-vote-icon "><b id="up-count"><?php echo $data['up-count']; ?></b><a id="up" onclick="like(this.parentNode.parentNode,<?php echo $data['post']->post_id; ?>)"  class="btn btn-sm <?php echo (!$data['up-voted']) ? 'btn-outline-success' : 'btn-success'; ?> ms-2"><i class="fa-solid fa-arrow-up "></i></a></div>
                        ...
                        <div class="row">
                            <div class="col-sm-10 mb-2 mt-2">
                                <input id="comment-text" type="text" class="form-control comment-text"
                                       placeholder="Write Comment">
                            </div>
                            <div class="col-sm-2">
                                <a onclick="comment(this.parentNode.parentNode,<?php echo $data['post']->post_id; ?>)"
                                   class="btn btn-sm btn-primary mb-2 mt-2" style="border-radius:10px;">Comment</a>
                            </div>
                        </div>
                    </div>
                </div>
